...
int main(int argc, char **argv)
{
	...
	//login(argv[1], "112.35.28.14", 6060, "4gpoc.com", argv[2], "123456");
	//sleep(1);
	//requestTalk("1234567890", 1);
	//sleep(1);
	//releaseTalk("1234567890", 1);
	//logout(argv[1]);
    return 0;
}
