...
PRODUCT_COPY_FILES += device/mediatek/mt6735/media_codecs_mediatek_video_gmo.xml:system/etc/media_codecs_mediatek_video.xml
...
PRODUCT_PACKAGES += consumerir.mt6737
...
#MMSDK (6753 use the same platform code with 6735)
...
PRODUCT_PACKAGES += audio.primary.mt6737
...
PRODUCT_PACKAGES += audio.usb.mt6737
...
PRODUCT_PACKAGES += sensors.mt6737
...
PRODUCT_PACKAGES += lights.mt6737
...
PRODUCT_PACKAGES += audio.r_submix.mt6737
...
PRODUCT_PACKAGES += camera.mt6737
...
PRODUCT_PACKAGES += satfi
PRODUCT_PACKAGES += SatFiApp
PRODUCT_PACKAGES += base
PRODUCT_PACKAGES += WifiTest
PRODUCT_PACKAGES += mtkgpio
PRODUCT_PACKAGES += n_gsm
PRODUCT_PACKAGES += power_mode
...
PRODUCT_PACKAGES += memtrack.mt6737
...
PRODUCT_PACKAGES += hwcomposer.mt6737
...
ifeq ($(strip $(MTK_GPU_SUPPORT)), yes)
  ifeq ($(MTK_PLATFORM),$(filter $(MTK_PLATFORM),MT6735))
	...
	PRODUCT_PACKAGES += gralloc.mt6737
...
PRODUCT_COPY_FILES += device/mediatek/mt6735/init.sensor_bio.rc:root/init.sensor_bio.rc
endif

ifneq ($(strip $(MTK_SENSOR_BIO)),yes)
PRODUCT_COPY_FILES += device/mediatek/mt6735/init.sensor.rc:root/init.sensor.rc
endif
...
PRODUCT_COPY_FILES += device/mediatek/mt6735/media_codecs.xml:system/etc/media_codecs.xml:mtk
PRODUCT_COPY_FILES += device/mediatek/mt6735/media_codecs_performance.xml:system/etc/media_codecs_performance.xml:mtk

ifneq ($(MTK_BASIC_PACKAGE), yes)
    ifeq ($(strip $(MTK_AUDIO_CODEC_SUPPORT_TABLET)), yes)
        PRODUCT_COPY_FILES += device/mediatek/mt6735/media_codecs_mediatek_audio_tablet.xml:system/etc/media_codecs_mediatek_audio.xml:mtk
    else
        PRODUCT_COPY_FILES += device/mediatek/mt6735/media_codecs_mediatek_audio_phone.xml:system/etc/media_codecs_mediatek_audio.xml:mtk
    endif
else
    PRODUCT_COPY_FILES += device/mediatek/mt6735/media_codecs_mediatek_audio_basic.xml:system/etc/media_codecs_mediatek_audio.xml:mtk
endif

PRODUCT_COPY_FILES += device/mediatek/mt6735/media_codecs_mediatek_video.xml:system/etc/media_codecs_mediatek_video.xml:mtk
...
PRODUCT_COPY_FILES += device/mediatek/mt6735/media_codecs_mediatek_video_svp.xml:system/etc/media_codecs_mediatek_video_svp.xml
endif
...
ifeq ($(strip $(TRUSTONIC_TEE_SUPPORT)), yes)
  ...
  PRODUCT_PACKAGES += keystore.mt6737
...
ifeq ($(strip $(MTK_WFD_HDCP_TX_SUPPORT)), yes)
  PRODUCT_PACKAGES += libstagefright_hdcptx_v2
endif
endif
...
ifeq ($(strip $(MICROTRUST_TEE_SUPPORT)), yes)
  ...
  PRODUCT_PACKAGES += gatekeeper.mt6737
