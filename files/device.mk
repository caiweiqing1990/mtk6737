...
include device/lentek/$(MTK_TARGET_PROJECT)/ProjectConfig.mk

# PRODUCT_COPY_FILES += device/lentek/len6737t_66_sh_n/egl.cfg:$(TARGET_COPY_OUT_VENDOR)/lib/egl/egl.cfg:mtk
# PRODUCT_COPY_FILES += device/lentek/len6737t_66_sh_n/ueventd.mt6735.rc:root/ueventd.mt6735.rc

PRODUCT_COPY_FILES += device/lentek/len6737t_66_sh_n/factory_init.project.rc:root/factory_init.project.rc
PRODUCT_COPY_FILES += device/lentek/len6737t_66_sh_n/init.project.rc:root/init.project.rc
PRODUCT_COPY_FILES += device/lentek/len6737t_66_sh_n/meta_init.project.rc:root/meta_init.project.rc

# about ethernet tangh add  0623
PRODUCT_COPY_FILES += frameworks/native/data/etc/android.hardware.ethernet.xml:system/etc/permissions/android.hardware.ethernet.xml
PRODUCT_COPY_FILES += device/lentek/len6737t_66_sh_n/mnl.prop:data/misc/gps/mnl.prop
PRODUCT_COPY_FILES += device/lentek/len6737t_66_sh_n/microcom:system/bin/microcom
...
PRODUCT_COPY_FILES += device/lentek/len6737t_66_sh_n/sbk-kpd.kl:system/usr/keylayout/sbk-kpd.kl:mtk \
                      device/lentek/len6737t_66_sh_n/sbk-kpd.kcm:system/usr/keychars/sbk-kpd.kcm:mtk
endif

# Add FlashTool needed files
#PRODUCT_COPY_FILES += device/lentek/$(MTK_TARGET_PROJECT)/EBR1:EBR1
#ifneq ($(wildcard device/lentek/$(MTK_TARGET_PROJECT)/EBR2),)
#  PRODUCT_COPY_FILES += device/lentek/$(MTK_TARGET_PROJECT)/EBR2:EBR2
#endif
#PRODUCT_COPY_FILES += device/lentek/$(MTK_TARGET_PROJECT)/MBR:MBR
#PRODUCT_COPY_FILES += device/lentek/$(MTK_TARGET_PROJECT)/MT6735_Android_scatter.txt:MT6735_Android_scatter.txt
...
ifeq ($(TARGET_BUILD_VARIANT),eng)
    PRODUCT_COPY_FILES += device/lentek/len6737t_66_sh_n/thermal_eng.conf:$(TARGET_COPY_OUT_VENDOR)/etc/.tp/thermal.conf:mtk
else
    PRODUCT_COPY_FILES += device/lentek/len6737t_66_sh_n/thermal.conf:$(TARGET_COPY_OUT_VENDOR)/etc/.tp/thermal.conf:mtk
endif
PRODUCT_COPY_FILES += device/lentek/len6737t_66_sh_n/ht120.mtc:$(TARGET_COPY_OUT_VENDOR)/etc/.tp/.ht120.mtc:mtk

PRODUCT_COPY_FILES += device/lentek/len6737t_66_sh_n/satbusy.wav:$(TARGET_COPY_OUT_VENDOR)/res/sound/satbusy.wav
...
PRODUCT_COPY_FILES += device/lentek/len6737t_66_sh_n/bohao.wav:$(TARGET_COPY_OUT_VENDOR)/res/sound/bohao.wav
...
PRODUCT_COPY_FILES += device/lentek/len6737t_66_sh_n/libTTUpdate.so:system/lib/libTTUpdate.so
PRODUCT_COPY_FILES += device/lentek/len6737t_66_sh_n/ipconfig.txt:system/etc/ipconfig.txt
...
PRODUCT_COPY_FILES += device/lentek/len6737t_66_sh_n/android.hardware.telephony.gsm.xml:system/etc/permissions/android.hardware.telephony.gsm.xml
...
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/len6737t_66_sh_n/factory/res/sound/testpattern1.wav:$(TARGET_COPY_OUT_VENDOR)/res/sound/testpattern1.wav:mtk
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/len6737t_66_sh_n/factory/res/sound/ringtone.wav:$(TARGET_COPY_OUT_VENDOR)/res/sound/ringtone.wav:mtk

# Keyboard layout
PRODUCT_COPY_FILES += device/mediatek/mt6735/ACCDET.kl:system/usr/keylayout/ACCDET.kl:mtk
PRODUCT_COPY_FILES += device/lentek/len6737t_66_sh_n/mtk-kpd.kl:system/usr/keylayout/mtk-kpd.kl:mtk

# Microphone
PRODUCT_COPY_FILES += device/lentek/len6737t_66_sh_n/android.hardware.microphone.xml:system/etc/permissions/android.hardware.microphone.xml

# Camera
PRODUCT_COPY_FILES += device/lentek/len6737t_66_sh_n/android.hardware.camera.xml:system/etc/permissions/android.hardware.camera.xml

# Audio Policy
PRODUCT_COPY_FILES += device/lentek/len6737t_66_sh_n/audio_policy.conf:$(TARGET_COPY_OUT_VENDOR)/etc/audio_policy.conf:mtk


#Images for LCD test in factory mode
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/len6737t_66_sh_n/factory/res/images/lcd_test_00.png:$(TARGET_COPY_OUT_VENDOR)/res/images/lcd_test_00.png:mtk
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/len6737t_66_sh_n/factory/res/images/lcd_test_01.png:$(TARGET_COPY_OUT_VENDOR)/res/images/lcd_test_01.png:mtk
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/len6737t_66_sh_n/factory/res/images/lcd_test_02.png:$(TARGET_COPY_OUT_VENDOR)/res/images/lcd_test_02.png:mtk
...
DEVICE_PACKAGE_OVERLAYS += device/lentek/len6737t_66_sh_n/overlay
...
$(call inherit-product-if-exists, vendor/lentek/libs/$(MTK_TARGET_PROJECT)/device-vendor.mk)
